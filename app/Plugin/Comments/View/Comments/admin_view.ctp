...
<h2><?php echo __('Comment'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($comment['ParentComment']['author'], array('controller' => 'comments', 'action' => 'view', $comment['ParentComment']['id'])); ?>
			&nbsp;
		</dd>
	...
	<?php foreach ($comment['ChildComment'] as $childComment): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'comments', 'action' => 'delete', $childComment['id']), array(), __('Are you sure you want to delete # %s?', $childComment['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
